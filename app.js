...
window.criarConta = () => {
    ...
    createUserWithEmailAndPassword(auth, e, s).then(() => alert("Conta criada e logada!")).catch(error => alert("Erro ao criar: " + (error.message || error.code)));
